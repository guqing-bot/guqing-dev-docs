...
<CardGroup cols={2}>  
  <Card title="Write Content" icon="pen-to-square" iconType="regular" color="var(--primary)" href="/essentials/markdown" imageFit="auto-height">
    Learn MDX syntax and start writing your documentation.
  </Card>
  <Card title="Customize style" icon="palette" iconType="regular" color="var(--primary)" href="/essentials/settings" imageFit="auto-height">
    Make your docs match your brand perfectly.
  </Card>
  <Card title="Add code examples" icon="square-code" iconType="regular" color="var(--primary)" href="/essentials/code" imageFit="auto-height">
    Include syntax-highlighted code blocks.
  </Card>
  <Card title="API documentation" icon="code" iconType="regular" color="var(--primary)" href="/api-reference/introduction" imageFit="auto-height">
...
<img
  src="/images/SCR-20231213-n4m.jpeg"
  alt="SCR-20231213-n4m.jpeg"
  title="SCR-20231213-n4m.jpeg"
  className="mx-auto"
/>
